...
import { getExpenseById, updateExpense, fileToDataURL } from '../../utils/storage';
...
export default function EditExpense() {
    ...
    try {
      ...
      if (!skipOCR) {
        try {
          ...
          setFormData({
            amount: extracted.amount || formData.amount,
            merchant: extracted.merchant || formData.merchant,
  ...
  if (error && error === 'Expense not found') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
        ...
        <div className="max-w-4xl mx-auto px-6 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Update your expense details</p>
            </div>
          </div>
        </div>
      </header>
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      ...
                      <p className="text-gray-700 font-semibold text-lg mb-2">Upload New Receipt</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm mt-2 text-yellow-700">
                    Don't worry! You can still update your expense manually below.
                  </p>
                </div>
              </div>
            </div>
