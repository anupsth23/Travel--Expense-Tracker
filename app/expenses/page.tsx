      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        {sortedExpenses.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">Start tracking your travel expenses to see them here</p>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex gap-2">
                        <Link
                          ...
                          className="text-blue-500 hover:text-blue-700 p-3 hover:bg-blue-50 rounded-xl transition-all duration-200 hover:scale-110"
